...
export const DefaultKeycloakStyling: Story = {
    render: () => (
        <KcPageStory
            kcContext={{
                uiMode: "default"
...
export const WithRestrictedToUh2cStudents: Story = {
    render: () => (
        <KcPageStory
            kcContext={{
                profile: {
                    attributesByName: {
                        email: {
                            validators: {
                                pattern: {
                                    pattern: "^[^@]+@((etu.univh2c\\.ma)|(univh2c\\.ma))$",
                ...
                "x-keycloakify": {
                    messages: {
                        "profile.attributes.email.inputHelperTextBefore": "Please use your Uh2c email.",
                        "profile.attributes.email.pattern.error":
                            "This is not an Uh2c Student email (<strong>@etu.univh2c.ma</strong>) nor a Uh2c (<strong>@univh2c.ma</strong>) email."
                    }
                }
            }}
        />
